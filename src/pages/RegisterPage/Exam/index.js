...
class Exam extends React.Component {
    ...
    return (
      ...
      >
        <section className="card" style={{width: "100%"}}>
          <Input value = {this.state.participantAddress} onChange = {this.handleTextChange} name = "participantAddress" placeholder="Participant address"/>
  ...
  registerParticipant() {
    ...
    this.trustExam.registerParticipant(participantAddress, selectedExamID, )
    .then(hash => {
